...
export class NegociacaoService {
    ...
    obtemNegociacoesDaSemana() {
        ...
        return this._http
            .get('http://localhost:3000negociacoes/semana')
            .then(
            dados =>
                dados.map(objeto =>
    ...
    obtemNegociacoesDaSemanaAnterior() {
        ...
        return this._http
            .get('http://localhost:3000negociacoes/negociacoes/anterior')
            .then(
    ...
    obtemNegociacoesDaSemanaRetrasada() {
        ...
        return this._http
            .get('http://localhost:3000negociacoes/negociacoes/retrasada')
            .then(
            dados => dados.map(objeto =>
                new Negociacao(new Date(objeto.data), objeto.quantidade, objeto.valor))
            ,
